...
public class StatisticController {
	...
	@ResponseBody
	public Map<String, Object> postStatistic(@PathVariable(value = "department") final String department,
	...
	@ResponseBody
	public Map<String, Object> loginStatistics(@PathVariable(value = "department") final String department,
			@PathVariable(value = "period") final String period,
			@PathVariable(value = "yearMonthDate") final String yearMonthDate) throws Exception {
	...
	@ResponseBody
	public Map<String, Object> visitStatistic(@PathVariable(value = "department") final String department,
			@PathVariable(value = "period") final String period,
			@PathVariable(value = "yearMonthDate") final String yearMonthDate) throws Exception {
